...
namespace Modules\Extend\Library;
...
//                            $mysqli_ok = true;
//                        } else {
//                            $results[] = new TestResult('The system installation requires an empty database, your database already has tables and data in it.', self::STATUS_ERROR);
//                            $mysqli_ok = false;
//                        }
                    } else {
